                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <!-- <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="btn delete"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item {{ isset($page) && in_array($page, ['meetings']) ? 'active-sidebar' : '' }}">
                        <a class="nav-link" href="{{ route('meetings') }}">
                            <i class="menu-icon mdi mdi-account-switch"></i>
